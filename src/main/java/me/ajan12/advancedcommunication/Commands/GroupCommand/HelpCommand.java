...
class HelpCommand {
    ...
    static boolean execute(final CommandSender player, final int page) {
        ...
        player.sendMessage(pluginTag + ChatColor.DARK_AQUA + " ----*---------*---- " + ChatColor.GOLD + "/group HELP " + page + ChatColor.DARK_AQUA + " ----*---------*---- " + pluginTag);

        //Checking if the requested page is 3.
        if (page == 3) {
            ...
            // -- "/gr <group> set help" command.
            player.sendMessage(pluginTag + " - " + ChatColor.YELLOW + "/group <group> set help" + ChatColor.GREEN + " : " + ChatColor.AQUA + " Shows the help page about editing a group's info.");
            player.sendMessage(pluginTag + " --- " + ChatColor.DARK_RED + "Group Admin command.");

        //Checking if the requested page is 2.
        } else if (page == 2) {
        ...
        player.sendMessage(pluginTag + " - " + ChatColor.AQUA + "'/group' command aliases: " + ChatColor.YELLOW + "g, gr, groups" + ChatColor.AQUA + ".");
        return true;
    }
}
