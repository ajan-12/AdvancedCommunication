...
public class SoftMuteCommand implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            if (!sender.hasPermission("advancedcommunication.command.softmute")) {
        ...
        //Checking if the target was already softmuted.
        if (targetUser.isHardMuted()) {

            //Un-softmuting the targetUser.
            targetUser.softMute(false);
            //Setting the mute length to 0L.
            targetUser.setMuteEnd(0L);
            //Setting the mute reason to " ".
            targetUser.setMuteReason(" ");

            //Feedbacking the sender.
            sender.sendMessage(pluginTag + ChatColor.GREEN + " Successfully un-soft-muted the player " + ChatColor.YELLOW + args[0] + ChatColor.GREEN + ".");
            return true;
        }
        ...
        //Softmuting the targetUser.
        targetUser.softMute(true);
        ...
        //Feedbacking the sender.
        sender.sendMessage(pluginTag + ChatColor.GREEN + " Successfully soft-muted the player " + ChatColor.YELLOW + args[0] + ChatColor.GREEN + ".");
        return true;
    }
}
